define ['backbone', 'underscore', 'mediator', './channels'], (Backbone, _, mediator, channels) ->
    ...
    class ContextModel extends Backbone.Model
        ...
        initialize: ->
            ...
            # if no ID is defined and this is the session context
            mediator.subscribe channels.CONTEXT_REMOVE, (id, node) =>
                # Shift arguments for session
                if not _.isNumber id
                    node = id
                    id = null
            ...
            mediator.subscribe channels.CONTEXT_CLEAR, (id) =>
                if @id is id or not id and @isSession()
                    @clear()
        ...
        save: =>
            ...
            super
            mediator.publish channels.CONTEXT_SYNCING, @
            @pending()
    ...
    class ContextCollection extends Backbone.Collection
        model: ContextModel
