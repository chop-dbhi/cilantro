define [
    ...
    class QueryView extends c.Backbone.View
        ...
        toggleHide: (event) ->
            event.preventDefault()
            c.publish 'queryview/hide', @model.id

        render: ->
            # Create a collection of the fields
            fields = new c.Backbone.Collection @model.get 'fields'
            ...
            # Subscribe to the session context
            c.subscribe c.Serrano.CONTEXT_SYNCED, (model) =>
                if model.isSession()
    ...
    class ConceptItemView extends c.Backbone.View
        tagName: 'li'
        ...
        click: (event) ->
            event.preventDefault()
            c.publish 'queryview/show', @model.id


    # Accordian representation of the data filters
    class QueryViewsAccordian extends c.Backbone.View
    ...
    class QueryViewsSearchForm extends c.Backbone.View
        template: c._.template '
    ...
    class QueryViewsPanel extends c.Backbone.View
        template: c._.template '
        ...
        initialize: (options) ->
            ...
            c.dom('body').append @$el
            @$el.panel()


    class QueryViewFilterList extends c.Backbone.View
        events:
        ...
        initialize: (options) ->
            ...
            c.subscribe c.Serrano.CONTEXT_SYNCING, =>
        ...
        render: (model) =>
            ...
            # Not filters
            if not node or c._.isEmpty(node)
                @$filters.append '
                    <div class=muted>
                ...
                ul = c.dom(@_parse(node).join '').addClass 'unstyled nav-list'
                @$filters.append ul
        ...
        clear: (event) ->
            event.preventDefault()
            c.publish c.Serrano.CONTEXT_CLEAR
