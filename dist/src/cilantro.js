...
define('cilantro/channels',[],function() {
  return {
...
define('cilantro/core',['jquery', 'underscore', 'backbone', 'mediator', './channels', './utils', './session', 'plugins/js', 'plugins/jquery-ajax-queue', 'plugins/backbone-deferrable'], function($, _, Backbone, mediator, channels, utils, session) {
  var aliases, c, currentSession, methods, props;
...
define('cilantro/models/field',['../core'], function(c) {
  ...
  FieldModel = (function(_super) {
    ...
    FieldModel.prototype.parse = function(resp) {
      var key, value, _ref;
      this.urls = {};
      this._cache = {};
      _ref = resp._links;
    ...
    FieldModel.prototype.distribution = function(handler, cache) {
      ...
      if (!(this.urls.distribution != null)) {
        handler();
      }
    ...
    FieldModel.prototype.stats = function(handler, cache) {
      var _this = this;
      if (cache == null) {
        cache = true;
      }
      if (!(this.urls.stats != null)) {
        handler();
      }
      if (cache && (this._cache.stats != null)) {
        handler(this._cache.stats);
      } else {
        c.Backbone.ajax({
          url: this.urls.stats,
          dataType: 'json',
          success: function(resp) {
            _this._cache.stats = cache ? resp : null;
            return handler(resp);
          }
        });
      }
    ...
    FieldModel.prototype.values = function(handler, cache) {
      var _this = this;
      if (cache == null) {
        cache = true;
      }
      if (!(this.urls.values != null)) {
        handler();
      }
  ...
  FieldCollection = (function(_super) {
    ...
    FieldCollection.prototype.initialize = function() {
      var _this = this;
      FieldCollection.__super__.initialize.apply(this, arguments);
...
define('cilantro/models/concept',['../core', './field'], function(c, field) {
  ...
  ConceptModel = (function(_super) {
    ...
    ConceptModel.prototype.parse = function(resp) {
      var attrs, _i, _len, _ref;
      this.fields = [];
      _ref = resp.fields;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        attrs = _ref[_i];
        this.fields.push(new field.FieldModel(attrs, {
          parse: true
        }));
      }
      return resp;
  ...
  ConceptCollection = (function(_super) {
    ...
    ConceptCollection.prototype.search = function(query, handler) {
      return c.Backbone.ajax({
        url: c._.result(this, 'url'),
        data: {
          q: query
...
define('cilantro/models/context',['../core'], function(c) {
  ...
  ContextNodeModel = (function(_super) {
    ...
    ContextNodeModel.prototype.isEmpty = function() {
      return c._.isEmpty(this.attributes);
    };
    ...
    ContextNodeModel.prototype.siblings = function() {
      if (this.isRoot()) {
        ...
        return c._.without(this.parent.get('children'), this);
      }
    };
    ...
    ContextNodeModel.prototype.promote = function() {
      ...
      children = c._.map([this.attributes].concat(__slice.call(nodes)), function(attrs) {
  ...
  parseAttrs = function(nodeModel, attrs, parent, callback) {
    ...
    if (!attrs || c._.isEmpty(attrs)) {
      ...
      children = c._.map(attrs.children, function(_attrs) {
  ...
  ContextModel = (function(_super) {
    ...
    ContextModel.prototype.initialize = function() {
      ...
      c.subscribe(c.CONTEXT_ADD, function(id, node) {
        if (!c._.isNumber(id)) {
          node = id;
          id = null;
        }
      ...
      c.subscribe(c.CONTEXT_REMOVE, function(id, node) {
        if (!c._.isNumber(id)) {
          node = id;
          id = null;
        }
    ...
    ContextModel.prototype.save = function() {
      ...
      c.publish(c.CONTEXT_SYNCING, this);
      return this.pending();
    };
...
define('cilantro/models/view',['../core'], function(c) {
  ...
  ViewModel = (function(_super) {
    ...
    ViewModel.prototype.initialize = function() {
      ...
      c.subscribe(c.VIEW_COLUMNS, function(id, columns) {
        var json;
        if (c._.isArray(id)) {
          columns = id;
          id = null;
      ...
      c.subscribe(c.VIEW_ORDERING, function(id, ordering) {
        var json;
        if (c._.isArray(id)) {
          ordering = id;
          id = null;
...
define('cilantro',['./cilantro/core', './cilantro/models'], function(c, models) {
  c.models = models;
  c.data = {
