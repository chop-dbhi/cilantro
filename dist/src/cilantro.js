...
define('serrano/channels',[],function() {
  return {
...
define('serrano/field',['backbone', 'underscore'], function(Backbone, _) {
  var FieldCollection, FieldModel;
  ...
  FieldCollection = (function(_super) {
    ...
    FieldCollection.prototype.search = function(query, process) {
...
define('serrano/concept',['backbone', 'underscore'], function(Backbone, _) {
  var ConceptCollection, ConceptModel;
  ConceptModel = (function(_super) {

    __extends(ConceptModel, _super);

    function ConceptModel() {
      return ConceptModel.__super__.constructor.apply(this, arguments);
    }
  ...
  ConceptCollection = (function(_super) {
    ...
    function ConceptCollection() {
      return ConceptCollection.__super__.constructor.apply(this, arguments);
    }

    ConceptCollection.prototype.model = ConceptModel;

    ConceptCollection.prototype.search = function(query, process) {
      return Backbone.ajax({
        url: _.result(this, 'url'),
        data: {
          q: query
...
define('mediator',['underscore'], function(_) {
  var channels;
  channels = {};
  return {
...
define('serrano/context',['backbone', 'underscore', 'mediator', './channels'], function(Backbone, _, mediator, channels) {
  var ContextCollection, ContextModel, ContextNodeModel, isBranch, isComposite, isCondition, parseAttrs, updateAttrs;
  ...
  ContextNodeModel = (function(_super) {
    ...
    function ContextNodeModel() {
      return ContextNodeModel.__super__.constructor.apply(this, arguments);
    }

    ContextNodeModel.prototype.validate = function(attrs) {
      var key, value;
    ...
    ContextNodeModel.prototype.toJSON = function() {
      var json, node;
      json = null;
      if (this.isBranch()) {
        json = {
    ...
    ContextNodeModel.prototype.isRoot = function() {
      return !(this.parent != null);
    };

    ContextNodeModel.prototype.isEmpty = function() {
      return _.isEmpty(this.attributes);
    };

    ContextNodeModel.prototype.isBranch = function() {
      return isBranch(this.attributes);
    };

    ContextNodeModel.prototype.isCondition = function() {
      return isCondition(this.attributes);
    };

    ContextNodeModel.prototype.isComposite = function() {
      return isComposite(this.attributes);
    };

    ContextNodeModel.prototype.siblings = function() {
      if (this.isRoot()) {
        return false;
      } else {
    ...
    ContextNodeModel.prototype.promote = function() {
      ...
      children = _.map([this.attributes].concat(__slice.call(nodes)), function(attrs) {
        return parseAttrs(_this.nodeModel, attrs, _this);
      });
      this.clear({
        slient: true
      });
    ...
    ContextNodeModel.prototype.demote = function() {
      if (this.isRoot()) {
        return false;
      }
    ...
    ContextNodeModel.prototype.add = function() {
      var nodes, _ref;
      nodes = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      if (!this.isBranch()) {
    ...
    ContextNodeModel.prototype.remove = function() {
      var children, idx;
      if (this.isRoot()) {
        this.clear();
      } else {
  ...
  parseAttrs = function(nodeModel, attrs, parent, callback) {
    var children, node;
    if (!attrs || _.isEmpty(attrs)) {
      ...
      children = _.map(attrs.children, function(_attrs) {
        return parseAttrs(nodeModel, _attrs, node, callback);
      });
      node.set({
        children: children
      });
  ...
  ContextModel = (function(_super) {
    ...
    function ContextModel() {
      ...
      return ContextModel.__super__.constructor.apply(this, arguments);
    }

    ContextModel.prototype.nodeModel = ContextNodeModel;

    ContextModel.prototype.deferred = {
      save: true,
      clear: true,
      add: false,
      remove: false
    ...
    ContextModel.prototype.url = function() {
      if (this.isNew()) {
        return ContextModel.__super__.url.apply(this, arguments);
      }
    ...
    ContextModel.prototype.initialize = function() {
      var _ref, _ref1, _ref2,
        _this = this;
      ContextModel.__super__.initialize.apply(this, arguments);
      ...
      this.on('sync', function() {
        this.resolve();
        return mediator.publish(channels.CONTEXT_SYNCED, this, 'success');
      });
      this.on('error', function() {
        return mediator.publish(channels.CONTEXT_SYNCED, this, 'error');
      });
      this.on('change', function() {
        return mediator.publish(channels.CONTEXT_CHANGED, this);
      });
      mediator.subscribe(channels.CONTEXT_PAUSE, function(id) {
        if (_this.id === id || !id && _this.isSession()) {
          return _this.pending();
        }
      });
      mediator.subscribe(channels.CONTEXT_RESUME, function(id) {
        if (_this.id === id || !id && _this.isSession()) {
          return _this.resolve();
        }
      });
      mediator.subscribe(channels.CONTEXT_ADD, function(id, node) {
        if (!_.isNumber(id)) {
          node = id;
          id = null;
        }
      ...
      mediator.subscribe(channels.CONTEXT_REMOVE, function(id, node) {
        if (!_.isNumber(id)) {
          node = id;
          id = null;
        }
      ...
      mediator.subscribe(channels.CONTEXT_CLEAR, function(id) {
        if (_this.id === id || !id && _this.isSession()) {
          return _this.clear();
        }
      });
    ...
    ContextModel.prototype.parse = function(resp) {
      if (resp) {
        if (!this.root) {
          this.nodes = {};
          this.clientNodes = {};
          this.root = parseAttrs(this.nodeModel, resp.json, null, this._referenceNode);
        } else {
    ...
    ContextModel.prototype.save = function() {
      this.set('json', this.root.toJSON());
      ContextModel.__super__.save.apply(this, arguments);
      mediator.publish(channels.CONTEXT_SYNCING, this);
      return this.pending();
    };

    ContextModel.prototype.toJSON = function() {
      var attrs;
      attrs = {
        id: this.id,
        name: this.get('name'),
    ...
    ContextModel.prototype._nodeSave = function(node) {
      if ((node.get('id') != null) && (node.get('value') != null)) {
        return this.save();
      }
    };

    ContextModel.prototype._referenceNode = function(node) {
      var cache;
      if (!(node.id != null)) {
        return;
      }
    ...
    ContextModel.prototype._deferenceNode = function(node) {
      var cache, idx;
    ...
    ContextModel.prototype.getNodes = function(id) {
      return this.nodes[id] || [];
    };

    ContextModel.prototype.add = function(node) {
      var branch;
    ...
    ContextModel.prototype.remove = function(node) {
      var children, idx;
      if (this.clientNodes[node.cid]) {
        if (node === this.root) {
          this.root = new this.nodeModel;
    ...
    ContextModel.prototype.clear = function() {
      var cid, node, _ref;
  ...
  ContextCollection = (function(_super) {
    ...
    function ContextCollection() {
      return ContextCollection.__super__.constructor.apply(this, arguments);
    }
...
define('serrano/view',['backbone', 'underscore', 'mediator', './channels'], function(Backbone, _, mediator, channels) {
  var ViewCollection, ViewModel;
  ViewModel = (function(_super) {
    ...
    ViewModel.prototype.deferred = {
      save: true
    };

    ViewModel.prototype.url = function() {
      if (this.isNew()) {
        return ViewModel.__super__.url.apply(this, arguments);
      }
      return this.get('_links').self.href;
    };
    ...
    ViewModel.prototype.initialize = function() {
      ...
      this.on('sync', function() {
        this.resolve();
        return mediator.publish(channels.VIEW_SYNCED, this, 'success');
      });
      this.on('error', function() {
        return mediator.publish(channels.VIEW_SYNCED, this, 'error');
      });
      this.on('change', function() {
        return mediator.publish(channels.VIEW_CHANGED, this);
      });
      mediator.subscribe(channels.VIEW_PAUSE, function(id) {
        if (_this.id === id || !id && _this.isSession()) {
          return _this.pending();
        }
      });
      mediator.subscribe(channels.VIEW_RESUME, function(id) {
        if (_this.id === id || !id && _this.isSession()) {
          return _this.resolve();
        }
      });
      mediator.subscribe(channels.VIEW_COLUMNS, function(id, columns) {
        var json;
        if (_.isArray(id)) {
          columns = id;
          id = null;
      ...
      mediator.subscribe(channels.VIEW_ORDERING, function(id, ordering) {
        var json;
        if (_.isArray(id)) {
          ordering = id;
          id = null;
    ...
    ViewModel.prototype.save = function() {
      ViewModel.__super__.save.apply(this, arguments);
      mediator.publish(channels.VIEW_SYNCING, this);
      return this.pending();
    };
...
define('serrano',['underscore', './serrano/channels', './serrano/field', './serrano/concept', './serrano/context', './serrano/view'], function() {
  var channels, mods, _;
  _ = arguments[0], channels = arguments[1], mods = 3 <= arguments.length ? __slice.call(arguments, 2) : [];
...
define('cilantro/utils',['underscore', './utils/numbers'], function() {
...
define('cilantro/session/channels',[],function() {
  return {
...
define('cilantro/session',['jquery', 'mediator', './session/channels'], function($, mediator, channels) {
...
define('plugins/backbone-deferrable',['jquery', 'underscore', 'backbone'], function($, _, Backbone) {
  var Deferrable;
  Deferrable = {
    deferred: {},
    initialize: function() {
...
define('cilantro/core',['jquery', 'underscore', 'backbone', 'serrano', 'mediator', './utils', './session', 'plugins/js', 'plugins/jquery-ajax-queue', 'plugins/backbone-deferrable'], function($, _, Backbone, Serrano, mediator, utils, session) {
  var aliases, c, channels, currentSession, methods, props;
...
define('cilantro/models/field',['../core', 'serrano'], function(c, Serrano) {
  var FieldCollection, FieldModel;
  FieldModel = (function(_super) {
  ...
  FieldCollection = (function(_super) {
    ...
    FieldCollection.prototype.initialize = function() {
      var _this = this;
...
define('cilantro/models/concept',['../core', 'serrano'], function(c, Serrano) {
  var ConceptCollection, ConceptModel;
  ConceptModel = (function(_super) {
...
define('cilantro/models/context',['../core', 'serrano'], function(c, Serrano) {
  var ContextCollection, ContextModel, ContextNodeModel;
  ContextNodeModel = (function(_super) {
...
define('cilantro/models/view',['../core', 'serrano'], function(c, Serrano) {
  var ViewCollection, ViewModel;
  ViewModel = (function(_super) {
...
define('cilantro/models',['./core', './models/field', './models/concept', './models/context', './models/view'], function() {
  var c, mods, _ref;
...
define('cilantro/router',['./core'], function(c) {
  var ROUTING, Router;
  ROUTING = false;
...
define('cilantro',['./cilantro/core', './cilantro/models', './cilantro/router'], function(c, models, Router) {
  c.models = models;
  c.data = {
