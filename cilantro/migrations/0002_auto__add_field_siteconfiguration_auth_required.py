...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteConfiguration.auth_required'
        db.add_column('cilantro_siteconfiguration', 'auth_required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteConfiguration.auth_required'
        db.delete_column('cilantro_siteconfiguration', 'auth_required')
