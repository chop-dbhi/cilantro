...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SiteConfiguration.site'
        db.alter_column('cilantro_siteconfiguration', 'site_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['sites.Site']))

    def backwards(self, orm):

        # Changing field 'SiteConfiguration.site'
        db.alter_column('cilantro_siteconfiguration', 'site_id', self.gf('django.db.models.fields.related.OneToOneField')(default=1, unique=True, to=orm['sites.Site']))
    ...
    models = {
        ...
        'cilantro.siteconfiguration': {
            ...
            'site': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'configuration'", 'unique': 'True', 'null': 'True', 'to': "orm['sites.Site']"}),
