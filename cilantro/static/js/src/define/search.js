...
define(['common/views/collection', 'common/models/state', 'common/views/state'], function(collectionview, statemodel, stateview) {
  var InputView, Result, ResultCollection, ResultItemView, ResultListView;
  Result = (function() {
  ...
  ResultListView = (function() {
    ...
    ResultListView.prototype.noResults = $('<div class="info">No results found</div>').hide();
    ...
    ResultListView.prototype.initialize = function(options) {
      if (!this.input) {
        ...
        this.content.append(this.noResults);
      }
      this.render();
    ...
    ResultListView.prototype.query = function(value) {
      var xhr;
      xhr = this.collection.query(value);
      return xhr.success(__bind(function(ids) {
        if (ids.length) {
          return this.noResults.hide();
        } else {
