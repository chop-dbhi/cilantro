...
define(['jquery', 'underscore', 'backbone', 'core/mixins', 'utils/grouper', 'utils/numbers', 'bootstrap', 'jquery.ui', 'plugins/panels', 'plugins/scroller'], function($, _, Backbone, Mixins, grouper, numbers) {
  ...
  $(function() {
    return syncStatus.appendTo('body');
  });
  return {
