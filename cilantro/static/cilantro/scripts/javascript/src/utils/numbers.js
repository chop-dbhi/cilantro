...
define(function() {
  var numberWithSeperator, numberWithSuffix, suffixes;
  ...
  numberWithSuffix = function(value) {
  ...
  numberWithSeperator = function(value, sep) {
    var arr, i, len;
    if (sep == null) {
      sep = ',';
    }
  ...
  return {
    numberWithSuffix: numberWithSuffix,
    numberWithSeperator: numberWithSeperator
  };
});
